package com.example.arqdsis.atividade02callbacks.util;

/**
 * Created by arqdsis on 08/03/2018.
 */
...
public class Utils {
    ...
    private static com.example.arqdsis.atividade02callbacks.util.StatusTracker mStatusTracker = com.example.arqdsis.atividade02callbacks.util.StatusTracker.getInstance();
